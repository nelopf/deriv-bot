...
# ATR multiplier calibrado por volatilidade de cada mercado
MARKETS = [
    {"symbol": "R_10",    "name": "Volatility 10",       "atr_mult": 2.5},
    {"symbol": "R_25",    "name": "Volatility 25",        "atr_mult": 3.0},
    {"symbol": "R_50",    "name": "Volatility 50",        "atr_mult": 3.5},
    {"symbol": "R_75",    "name": "Volatility 75",        "atr_mult": 4.0},
    {"symbol": "R_100",   "name": "Volatility 100",       "atr_mult": 4.5},
    {"symbol": "1HZ10V",  "name": "Volatility 10 (1s)",   "atr_mult": 2.5},
    {"symbol": "1HZ25V",  "name": "Volatility 25 (1s)",   "atr_mult": 3.0},
    {"symbol": "1HZ50V",  "name": "Volatility 50 (1s)",   "atr_mult": 3.5},
    {"symbol": "1HZ75V",  "name": "Volatility 75 (1s)",   "atr_mult": 4.0},
    {"symbol": "1HZ100V", "name": "Volatility 100 (1s)",  "atr_mult": 4.5},
]
...
def analyze_signal(symbol, atr_mult):
    ...
    sl_mult  = atr_mult * 1.2
    tp1_mult = atr_mult * 2.0
    tp2_mult = atr_mult * 3.5
...
async def main():
    ...
    await send_telegram(
        ...
        "━━━━━━━━━━━━━━━━━━━━\n"
        "📊 10 mercados Volatility\n"
        "📐 Estratégia: H1 + H4 confirmado\n"
        "🔍 Filtros: EMA Tripla + MACD + RSI + ADX + Bollinger + Padrão de Candle\n"
